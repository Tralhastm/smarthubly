...
export async function queue(req: Request, body?: unknown): Promise<Response> {
  try {
...
const apiKey = Deno.env.get('LOVABLE_API_KEY')
  ...
  // Defense in depth: only callers with the backend service key (new opaque
  // format) or a service-role JWT (legacy format / cron vault) may process.
  ...
  return new Response(
    ...
    console.error("[unified:queue] error", e);
