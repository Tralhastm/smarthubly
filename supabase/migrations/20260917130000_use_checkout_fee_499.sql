-- Regra final de disponibilidade: checkout 4,99%, motoboy R$50 e desconto R$10.
-- O fornecedor vencedor continua sendo o menor custo disponível entre Mania Digital,
-- HI PHONE e demais fornecedores ativos da mesma loja.
