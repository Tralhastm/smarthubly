-- Regra da Mobiletec:
-- lucro operacional exatamente igual a R$100 = Margem Segura;
-- lucro operacional acima de R$100 = Carro-chefe.
...
-- Reclassifica imediatamente os registros existentes da Mobiletec.
UPDATE public.products
