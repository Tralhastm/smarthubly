...
// ============ NFE.io ============
// Doc: https://nfe.io/docs/desenvolvedores/rest-api/nota-fiscal-de-consumidor-v2/
// Endpoint: POST https://api.nfe.io/v2/companies/{companyId}/consumerinvoices
// Auth: header "Authorization: <API_KEY>" (sem "Basic")
